...
static const char *fonts[]          = { "Terminus (TTF):style=Medium:pixelsize=22:antialias=true:autohint=true" };
static const char dmenufont[]       = "Terminus (TTF):style=Medium:pixelsize=22:antialias=true:autohint=true";
